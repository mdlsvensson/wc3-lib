/**
 * Warcraft adapter for `DummyManager`: `createWarcraftDummies` creates locust,
 * invulnerable, unpathed dummies, gives them the ability and full mana, and issues the order.
 *
 * @example
 * ```ts
